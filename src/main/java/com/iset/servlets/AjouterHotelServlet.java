...
@WebServlet("/AjouterHotelServlet")
...
public class AjouterHotelServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		this.getServletContext().getRequestDispatcher("/WEB-INF/views/ajouterHotel.jsp").forward(request, response);			
	}
	...
	private void insertHotel(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int nombre = hotel_methode.countHotel() + 1 ; 
        hotel.setId(nombre);
        System.out.println(hotel_methode.countHotel());
        ...
        user_hotel.setUtilisateur_EMAIL(email);
        try {
        	/**/
        	hotel_methode.saveHotel(hotel);
