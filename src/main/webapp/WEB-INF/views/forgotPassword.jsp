			...
			<div
				...
				<div class="col-lg-8 col-xl-6">
					<div class="card rounded-3">
						<img
							src="${pageContext.request.contextPath}/img/img3.png"
							class="w-100"
							...
							<form class="px-md-2" action="ForgotPassword" method="POST">
								<div class="form-outline mb-4">
									<span style="color: red">${ErrorEmail}</span> <input
										...
										name="code" required /> <label class="form-label"
										for="form3Example1q"> Donnez Votre Code </label>
								</div>
								<div class="form-outline mb-4">
									<span style="color: red">${ErrorEmail}</span> <input
										type="password" id="form3Example1q" class="form-control"
										name="password" required /> <label class="form-label"
										for="form3Example1q"> Donnez Password </label>
								</div>
								<div class="form-outline mb-4">
									<span style="color: red">${ErrorEmail}</span> <input
										type="password" id="form3Example1q" class="form-control"
										name="repertPassword" required /> <label class="form-label"
